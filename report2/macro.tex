...
\newcommand{\notes}[1]{}
\newcommand{\listofnotes}[0]{}

\ifthenelse{\value{notes} > 0}{
    \renewcommand{\notes}[1]{\todo[noshadow]{#1}}
    \renewcommand{\listofnotes}[0]{\listoftodos}
}{}
...
\newcommand{\controlpulse}{\gamma}
\newcommand{\dimD}{\mathcal{D}}
\newcommand{\reachable}{\mathcal{W}}
\newcommand{\polyreachable}{\mathcal{W^+}}
